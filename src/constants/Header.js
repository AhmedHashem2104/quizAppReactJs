        ...
        <div>
            <div className="nav-header">
                <Link to="index-2.html" className="brand-logo">
                    <img className="logo-abbr" src="https://logos-world.net/wp-content/uploads/2020/04/Huawei-Logo.png" alt="" />
                    <img className="logo-compact" src="https://logos-world.net/wp-content/uploads/2020/04/Huawei-Logo.png" alt="" />
                    <img className="brand-title" src="https://logos-world.net/wp-content/uploads/2020/04/Huawei-Logo.png" alt="" />
                </Link>
            </div>
                        ...
                        <div className="collapse navbar-collapse justify-content-between">
                            ...
                            <ul className="navbar-nav header-right">
                                <li className="nav-item dropdown notification_dropdown">
                                    <Link className="nav-link bell ai-icon" to="#" role="button" data-toggle="dropdown">
                                        <svg id="icon-user" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-bell">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right">
                                        ...
                                        <Link className="all-notification" to="#">See all notifications <i
                                ...
                                <li className="nav-item dropdown header-profile">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right">
                                        ...
                                        <Link to="#" onClick={() => { localStorage.setItem("token", ""); route.push("/login") }} className="dropdown-item ai-icon">
